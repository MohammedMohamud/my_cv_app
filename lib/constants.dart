...
const TextStyle kTittleTextStyle
...
const TextStyle kRegularSmallTextStyle
= TextStyle(fontFamily: "Bebas", fontSize: 18.5);

const TextStyle kBoldTextStyle
= TextStyle(fontFamily: "Bebas", fontWeight: FontWeight.bold, fontSize: 18.5);